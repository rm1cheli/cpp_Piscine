...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/06/27 15:08:34 by rmicheli          #+#    #+#             */
/*   Updated: 2022/06/27 15:08:35 by rmicheli         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
const char* Form::GradeTooHighException::tt(){
	return ("the grade is too high, it cannot be under 1");
}
const char* Form::GradeTooLowException::tt(){
